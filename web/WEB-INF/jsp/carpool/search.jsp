...
<div class="container">
    ...
    <div class="containerWrapper">
        <div class="leftContent">
            <h3 style="font-weight: normal;" id="resultsMessage">Your search for "${searchQuery}"
                returned ${searchResult == null ? 0 : searchResult.size()} result{s}</h3>
        ...
        <div class="routePoints">
            <h4 style="font-weight: normal;">Route Points</h4>
